    ...
    <section id="tz-project-cresadmin" class="tz-project-wrapper">
        ...
        <div class="tz-project-screen">
            <div class="tz-project-screen-wrapper">
                <img src="images/projects/cresadmin/cresadmin_1_s.png" class="tz-lazy-display" width="1300" height="800" alt="cresadmin1">
            </div>
        </div>
        ...
        <div class="tz-project-screen">
            <div class="tz-project-screen-wrapper">
                <img src="images/projects/cresadmin/cresadmin_2_s.png" class="tz-lazy-display" width="1300" height="800" alt="cresadmin2">
            </div>
        </div>
        ...
        <div class="tz-project-screen">
            <div class="tz-project-screen-wrapper">
                <img src="images/projects/cresadmin/cresadmin_3_s.png" class="tz-lazy-display" width="1300" height="800" alt="cresadmin3">
            </div>
        </div>
