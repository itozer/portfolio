...
<body>
    ...
    <section id="tz-secondary-header">
        <h3>SkyDump</h3>
        <p>
            I created SkyDump to save the office, and myself, a bit of time and frustration when nature calls. SkyDump tells you what bathrooms are available so that you don't have to walk around looking for one that is free. You can check out a demo of the app <a href="http://www.skydump.info" target="_blank">here</a>, or below.
        </p>
    </section>
        ...
        <section id="tz-project-skydump" class="tz-project-wrapper">
            ...
            <div class="tz-project-screen">
                <div id="tz-skydump-wrapper" class="tz-project-screen-wrapper">
                    <iframe src="http://www.skydump.info"></iframe>
                </div>
            </div>2
